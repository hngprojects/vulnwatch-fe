          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4">
            ...
            {status === "success" && (
              <>
                ...
                <Link
                  href="/login"
                  className="bg-primary mt-4 flex h-[44px] w-full items-center justify-center rounded-[8px] px-6 text-[16px] font-medium text-white transition-opacity hover:opacity-90 active:scale-[0.
                >
                  Go to Login
                </Link>
              </>
            ...
            {status === "error" && (
              <>
                ...
                <Link
                  href="/login"
                  className="mt-4 flex h-[44px] w-full items-center justify-center rounded-[8px] border border-[#C68A00] px-6 text-[16px] font-medium text-[#C68A00] transition-colors hover:bg-[#C68A00
                >
                  Back to Login
                </Link>
              </>
