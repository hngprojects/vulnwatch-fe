          ...
          >
            ...
            <div className="mt-2 flex flex-col gap-6">
              <button
                ...
                className="bg-primary font-geist flex h-[44px] w-full items-center justify-center gap-2 rounded-[8px] px-6 py-4 text-[16px] leading-[24px] font-medium tracking-[0.02em] text-[#FFFFFF] 
              >
                {isSubmitting ? (
                  <>
