    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-[#E5E7EB] p-6">
        ...
        <div>
          ...
          <div className="flex justify-end gap-3 mt-6">
            <button className="py-3 px-5 sm:px-10 text-sm sm:text-[16px] font-semibold text-[#666666] border border-[#EDEDED] rounded-lg transition-colors cursor-pointer">
              Cancel
            </button>
      ...
      <div className="bg-white rounded-2xl border border-[#E5E7EB] p-6">
        ...
        <div className="flex items-center justify-between border border-[#E5E7EB] rounded-lg px-4 py-3 mt-5">
          <span className="text-[16px] font-normal text-[#2B2B2B]">Sessions Alert</span>
          <button
            role="switch"
        ...
        <div className="flex items-center justify-between border border-[#E5E7EB] rounded-lg px-4 py-3 mt-5">
          <span className="text-[16px] font-normal text-[#2B2B2B]">Suspicious Login Alerts</span>
          <button
            role="switch"
        ...
        <div className="flex items-center justify-between border border-[#E5E7EB] rounded-lg px-4 py-3 mt-5">
          <span className="text-[16px] font-normal text-[#2B2B2B]">New Device Alets</span>
          <button
            role="switch"
