        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onRescan && (
            <Button
              ...
              className="border-[1.5px] border-primary text-primary bg-transparent hover:bg-primary/10 flex items-center justify-center font-medium h-8 w-8 px-0 shrink-0 disabled:opacity-60"
              onClick={onRescan}
            >
              {isRescanning ? (
                <Loader2 size={16} className="animate-spin text-primary" />
              ) : (
                <RefreshCcw strokeWidth={2.2} size={16} />
              )}
            </Button>
          )}
        </div>
        ...
        <div className="items-center gap-4 hidden lg:flex">
          ...
          {onRescan && (
            <Button
              variant="outline"
              disabled={isRescanning}
              className="border-[1.5px] border-primary text-primary bg-transparent hover:bg-primary/10 flex items-center gap-2 disabled:opacity-60 font-semibold h-auto py-3 px-5 rounded-xl text-base shrink-0"
              onClick={onRescan}
            >
              {isRescanning ? (
