            ...
            <div className="relative">
              ...
              <div className="absolute top-0 translate-y-[-72%] left-1/2 translate-x-[-50%] z-10">
                ...
                >
                  ...
                  <path
                    d="M78.0174 47.2035L57.9549 67.266C57.4861 67.7345 56.8505 67.9977 56.1877 67.9977C55.525 67.9977 54.8893 67.7345 54.4205 67.266L43.2299 56.016C42.7619 55.5473 42.499 54.912 42.499
                    fill="white"
                  />
                  <rect
                    opacity="0.5"
