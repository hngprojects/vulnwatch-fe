      ...
      >
        ...
        {isSelected && (
          <span className="sm:hidden absolute right-4 top-4">
            ...
            >
              <path
                d="M8.74462 15.9999C10.9829 15.9801 13.1989 15.1276 14.7923 13.6797C16.6848 11.9602 17.6595 9.41585 17.3195 6.98704C16.7369 2.82448 13.0155 0 8.68872 0C5.40164 0 2.20662 1.89064 0.8053
                fill="#072E28"
              />
              <path
                d="M8.68968 13.641C12.0827 13.641 14.8332 11.1121 14.8332 7.9924C14.8332 4.87274 12.0827 2.34375 8.68968 2.34375C5.2967 2.34375 2.54614 4.87274 2.54614 7.9924C2.54614 11.1121 5.2967 13
                fill="#072E28"
              />
            </svg>
          </span>
