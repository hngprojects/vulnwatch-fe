...
function ScanIcon() {
  return (
    ...
    >
      <path
        d="M21.375 3.75V7.5C21.375 7.79837 21.2565 8.08452 21.0455 8.2955C20.8345 8.50647 20.5484 8.625 20.25 8.625C19.9516 8.625 19.6655 8.50647 19.4545 8.2955C19.2435 8.08452 19.125 7.79837 19.125 7
        fill="#072E28"
      />
    </svg>
  );
